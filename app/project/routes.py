...
def project(term):
    ...
    project_link = Project.query.join(Userstory, Priority, Team).with_entities(Project.name.label('project_name'),
                                                                               Project.project_id,
                                                                               Userstory.userstory_id,
                                                                               Userstory.content,
    ...
    current_project = Project.query.with_entities(Project.name, Project.project_id).filter(
        Project.project_id == term).first()
    if not project_link:
...
def edit_project(id):
    ...
    if request.method == 'GET':
        ...
        try:
            ...
            flash("Not validated project name")
